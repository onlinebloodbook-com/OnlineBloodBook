...
<div id="register">
 ...
 <input type="hidden" name="regBloodAvailability" id="regBloodAvailability"  value="available">
  ...
  <td> <select onchange="set_country(this,regDistrict,regCity)" size="1" name="regState" id="regState" class="inputt validate[required]">
   ...
   <tr>
   <td> Select City:</td>
  <td> <select name="regCity" size="1" disabled="disabled" onchange="print_city_state(regDistrict,this)" class="inputt"></select></td>
  </tr>
    </table>
...
<display:caption >Search List </display:caption>
...
<display:column title="send Request"  href="requestLink2"
            media="html" paramId="regId" paramProperty="regId"><span style=" color:white; border-radius: 2px; background: #BF0300; font-size: 16px; box-shadow: 0 0 0 2px #bf9543; background-image: -webkit-linear-gradient(top,#BF0300,#BF0300); padding:2px 16px;">Request</span></display:column>
